//! Still images as timeline sources (D-292).
//!
...
//! invented. See D-292 for why it is a strict subset of that list.
...
/// inventing a fact the file does not contain (D-292).
...
mod tests {
    ...
    fn ext_gate_matches_the_documented_list() {
        ...
        // D-292 — deliberately excluded: one frame is the whole contract.
