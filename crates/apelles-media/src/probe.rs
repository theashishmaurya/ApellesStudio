...
//! `apelles-media` to depend on `app/src-tauri` — a cycle. It moved out first,
...
/// D-281 — the pixel dimensions of **any** placeable source: a still through
...
/// one-frame video, which is the bug D-281 is fixing.
