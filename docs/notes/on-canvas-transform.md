...
*(D-218 note: "the picture's real on-screen rect" is no longer just the letterbox
fit — the preview has a viewport zoom/pan on top of it now. See the coordinate-
contract row in the STATUS table above; the letterbox math below is still the
base of it, unchanged.)*
