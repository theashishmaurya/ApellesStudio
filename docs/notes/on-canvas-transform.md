...
- **Which clip?** (D-202 note: still true — canvas click-to-select sets that same
...
- **Not in Phase 1:** rotation, non-uniform scale, crop, anchor point, click-to-select,
  ...
  on top of Phase 1, unchanged — D-202, 2026-09-07; see Open Question 3.)
...
3. ~~**Click-on-picture to select** — genuinely useful, but it needs the backend to report
   ...
   **Built 2026-09-07 (D-202), as its own slice, fixing B-085** — the owner hit the gap
