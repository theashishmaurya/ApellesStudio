...
**D-273**, 2026-09-10. Closes the two owner requests logged 2026-09-10: *"a full
...
This note is the worked-out detail behind D-273. The code lives in
...
### What owned a shortcut before D-273
...
Before D-273 both fired; now one does, and the loser is visible instead of
silent.
...
| Action | Default | Scope | Status before D-273 |
| --- | --- | --- | --- |
...
gained. Reasoning recorded in D-273 rather than a tool being forced to fit.
