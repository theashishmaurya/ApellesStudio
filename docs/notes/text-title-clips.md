# Text / title clips in the Edit tab (D-209 · D-210 · D-211)
...
## The model — D-209: a `Clip` variant, not a `TrackKind`
...
- **`font` is a catalogue key, not a path or a system family name.** See D-210.
...
`drawtext` filter (D-211), which can place a text box and fade it and nothing
...
## The live preview — D-210: `ab_glyph`, and one shared font file
...
## The export — D-211: `drawtext`, spliced into the overlay chain
