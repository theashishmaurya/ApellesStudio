...
## D-051 — Global undo/redo: a new `@chroma/history` package (generic stack, not `@chroma/bridge`), snapshot-based bridges for both existing edit surfaces, shell-owned Cmd/Ctrl+Z that switches tabs
**decided (2026-09-03) · built (2026-09-03)**
