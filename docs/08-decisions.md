...
## D-056 — Timeline UI fixes: `timeline.ts` gets D-054's `start_frame` for real (B-012/B-013), `TimelineSwitcher` rebuilt as a tab strip, an adaptive-density real-timecode ruler
