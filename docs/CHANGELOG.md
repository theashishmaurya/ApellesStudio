...
- **2026-09-08** — **Per-property keyframes and per-property reset in the Edit
  tab's Inspector (D-205).** Every Transform/Crop row now has its own
  ...
  as an explicit batch shortcut. **Found and fixed B-092 on the way:** the
  ...
  untouched. **Filed B-093, not fixed:** the ffmpeg export compiler ignores
