/**
 * @apelles/editor — the Edit tab's audio-transport request stamp (D-130, moved
 ...
 * (`apelles_media::audio`'s `SESSION`), and `begin_request` drops any request
 ...
 * stamp at all — see `apelles_media::scrub::update` for why a level needs no
 * ordering token.)
 *
