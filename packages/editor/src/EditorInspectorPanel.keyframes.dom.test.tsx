...
/**
 * @chroma/editor — real-DOM coverage for D-205's per-property keyframing:
 ...
 * each_param_interpolates_across_only_its_own_keyframes`'s job (B-092), and
...
describe('per-property keyframing (D-205)', () => {
...
describe('per-property keyframe navigation (D-205)', () => {
...
describe('per-property reset (D-205)', () => {
...
describe('the whole-clip Keyframes section (D-205 — kept, and now merging)', () => {
  ...
  /** The destructive case the pre-D-205 wholesale upsert had: a single
