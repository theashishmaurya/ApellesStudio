 ...
 *
 * B-083/D-202 — **that one input carries the project's identity, not just a
...
interface EditorTimelineState {
   ...
   *
   *  B-083/D-202 — this was a bare `projectOpen: boolean` until 2026-09-07,
 ...
 *  one — including, since B-083/D-202, a switch straight from one open project
 *  to another. */
