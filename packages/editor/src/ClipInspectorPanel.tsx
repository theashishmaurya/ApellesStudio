...
export function ClipInspectorPanel({
  ...
  /** The `FADE_PRESETS` name of the ease the next bake will use. A name rather
   *  than a `FadeCurve` because the `<select>` speaks names, and unlike the
  ...
  onDynamicZoomEase: (curve: FadeCurve) => void;
