 ...
 * selection, never sets it** — still true after D-202: clicking the picture
 ...
 * on this list until D-202 — see above.)
 *
        ...
        {!trackLocked &&
          CORNERS.map((corner) => {
            ...
            return (
              <div
                key={corner}
                // D-202 — marks this as a real corner-grab target, so canvas
