 ...
 * click-to-select (D-202, fixing B-085), built on `testUtils/pointerHarness.ts`
...
describe('canvas click-to-select (D-202 / B-085)', () => {
  ...
  describe('coexistence with the transform handles', () => {
    ...
    it('selects a HIGHER layer through the selected clip’s own full-bleed transform box', async () => {
      // The real-browser finding that reshaped D-202 (see this hook's doc): a
