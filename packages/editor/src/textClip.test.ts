// @chroma/editor — the text/title clip primitive's pure logic (D-209/D-211,
...
describe('newTextLayer', () => {
  ...
  it('rejects multi-line content — Phase 1 is single-line, provably (D-211)', () => {
...
describe('newTextClipFields', () => {
  ...
  it('is placed by the ORDINARY add_clip op, with ripple and explicit positions', () => {
    // The whole payoff of the Clip-variant shape (D-209): no new placement
...
describe('buildExportFfmpegArgs — text clips', () => {
  ...
  it('leaves a timeline with no text clips byte-identical to before D-209', () => {
