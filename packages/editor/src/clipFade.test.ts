/**
 * @chroma/editor — unit coverage for `clipFade.ts` (D-205), the pure geometry
...
describe('fadeFramesToPx / pxToFadeFrames (D-205)', () => {
...
describe('clampFadeDragPx — a DRAG clamp, not a model clamp (D-205)', () => {
...
describe('fadeRampPaths — the REAL curve, not a straight-line approximation (D-205)', () => {
  const W = 200;
  const H = 52;
...
describe('fadeUnityLinePath (D-205)', () => {
