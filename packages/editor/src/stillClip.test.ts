/**
 * @apelles/editor — still images as timeline sources (D-281), the model half.
 *
...
describe('mediaSourceFacts (D-281)', () => {
  ...
  it('leaves footage exactly as it was before D-281', () => {
...
describe('placing a still (D-281)', () => {
