...
/**
 * @remarks The RapidRAW original localised its two visibility-toggle tooltips
 * via `react-i18next`; extracted into `@chroma/ui` (D-039) the strings are
 * inlined (English) to keep the kit's deps to react + clsx + lucide-react.
 */
