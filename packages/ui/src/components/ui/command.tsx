...
/**
 * shadcn `command` (D-042). `cmdk` is primitive-agnostic; `CommandDialog` wraps
 * this kit's Base UI `Dialog`. Highlighted item uses cmdk's `data-[selected=true]`
 * → `bg-muted` (the `--accent` decision).
 */
