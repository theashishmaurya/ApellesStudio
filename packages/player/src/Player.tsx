 ...
 *
 * D-278 added a real PLAYBACK-RATE control to the transport cluster
...
export interface PlayerProps {
   ...
   * second (D-278). `1` is ordinary playback. Omit `rate` → the whole control
...
/**
 * D-278 — the playback-rate control: a readout that opens a preset list plus a
 ...
 * the owner's reference screenshot asks for. See D-278, and the roadmap line
    ...
    <div className={cn('flex flex-col min-h-0 flex-1 bg-bg-primary', className)}>
      ...
      <div className="shrink-0 flex flex-col border-t border-border-color bg-surface text-text-primary">
        ...
        <div className="flex items-center gap-1 px-3 py-2">
          ...
          {/* D-278 — the playback-rate control, in the LEFT cluster with the
