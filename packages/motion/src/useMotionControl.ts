 ...
 *
 * **What this file is, after D-255: the SHELL only.** The ops themselves
 ...
 *
 * **Why the split (D-255).** The registry used to be an object literal
 ...
 *
 * **What happens to a rendered file (verified, D-255).** Every scene's output
 ...
 * yet.
 *
 * D-255 adds `selections` — the READ half. `motion_get_state`/
