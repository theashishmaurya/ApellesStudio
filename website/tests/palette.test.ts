 ...
 * two million tesserae, asserted literally as one CSS declaration. D-284
...
describe('the brand palette is exactly the documented one', () => {
  ...
  /**
   * D-287: the owner removed the Footer's own colophon paragraph — the
...
describe('the primary action has one consistent treatment (D-284: ink, not a scarce colour)', () => {
