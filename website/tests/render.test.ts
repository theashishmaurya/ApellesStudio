...
describe('the headline carries the whole proposition on its own', () => {
  ...
  it('offers exactly one next step — a real action, not a link (D-273)', () => {
...
describe('the beta form is real', () => {
  ...
  /**
   * D-273: the signature moved up to Hero.astro's own copy of this form —
...
describe('the beta section’s own button is deliberately not the signature (D-273)', () => {
