 ...
 * the signature moved from rose to ink 2026-09-10 — D-284).
 *
 ...
 * that page exists for. D-284 retired it. The pink was scarce in the mosaic
 ...
 *
 * Six pigments now, not seven (D-284 retired `pigment-rose` — see this file's
...
export const PIGMENTS: readonly Pigment[] = [
  ...
  },
  {
    ...
    role:
      'Ink, the ground behind product imagery, and — as of D-284 — the site’s one consistent primary-action fill (a solid ink pill, marble text). A warm black, never #000.',
  },
  {
  ...
  },
  {
    ...
    role:
      'The second working colour: rules, marks and large display type on marble (3.0:1, never body text there) — and, on a basalt ground, links and highlighter-style marks besides (5.1:1 there, D-282’s own finding).',
  },
];
