...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            chroma::commands::chroma_video_info,
            chroma::commands::chroma_seek,
            chroma::playback::chroma_play_frame,
            chroma::commands::chroma_frame_thumbnails,
            chroma::session::chroma_session_list,
            chroma::session::chroma_session_add,
            chroma::session::chroma_session_set_active,
            chroma::session::chroma_session_remove,
            chroma::session::chroma_session_thumbnail,
            chroma::project::chroma_project_list,
            chroma::project::chroma_project_open,
            chroma::project::chroma_project_new,
            chroma::project::chroma_project_save,
            chroma::project::chroma_project_relink,
            ...
            chroma::project::chroma_media_refresh,
            chroma::project::chroma_media_reprobe,
            ...
            chroma::audio::chroma_audio_scrub_begin,
            chroma::audio::chroma_audio_scrub_update,
            chroma::audio::chroma_audio_scrub_end,
            chroma::mask::chroma_subject_mask,
            chroma::mask::chroma_ai_health,
            chroma::mask::chroma_track_subject,
            chroma::mask::chroma_track_status,
            chroma::mask::chroma_refine_tracked_frame,
            chroma::depth::chroma_depth_track,
            chroma::depth::chroma_depth_track_status,
