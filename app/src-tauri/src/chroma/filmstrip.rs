...
//! the `ffmpeg` extraction are all `chroma_media::filmstrip` now. This file
...
/// unchanged.
pub use chroma_media::filmstrip::ClipThumbDto;
...
/// [`chroma_media::filmstrip::clip_thumbnails`] for the real contract.
#[tauri::command]
pub async fn chroma_clip_thumbnails(
    ...
    chroma_media::filmstrip::clip_thumbnails(source_path, start_secs, duration_secs, step_secs).await
}
