//! Text/title rasterisation for the Edit tab (D-209/D-210,
...
//!   the whole reason live preview and export draw the same glyphs (D-210).
...
//!
//! **Why `ab_glyph` (D-210):** it is already in this workspace's dependency
...
///
/// **Candidate paths rather than a font-discovery library** (D-210): the
...
///
/// **The INK box, not the font's ascent/descent box** (D-211). ffmpeg's
...
/// live preview and the export agree** (D-210/D-211).
///
