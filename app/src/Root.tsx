 ...
 *
 * B-083/D-202 — that signal is now the open project's **identity**
...
export function Root() {
  ...
  // B-083/D-202 — *which* project is open, not merely whether one is. Every
  ...
  // costs nothing.
  //
  // B-083/D-202 — what's handed over is the project's identity, not a
  ...
  // is both the narrower signal and (B-083/D-202) Motion's own project
  ...
  // B-083/D-202 — the same bridge for the media pool, whose items are what
