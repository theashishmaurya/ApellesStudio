...
export default function Editor({ onContextMenu, onImageSelect, transformWrapperRef }: EditorProps) {
  ...
  useChromaSubjectTracking(); // single mount: seek-settle -> ViTMatte upgrade
  // useChromaControl() moved to App (app-level mount, works before a file is open — D-020 / docs/04)
